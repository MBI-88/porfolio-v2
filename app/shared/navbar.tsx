            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
                ...
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white">
                        ...
                        <li>
                            <Link href="/pages/work" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 ">
                                <span className="self-center text-xl font-semibold whitespace-nowrap">Works</span>
                            </Link>
                        </li>
                        <li>
                            <Link href="/pages/certs" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 ">
                                <span className="self-center text-xl font-semibold whitespace-nowrap ">Certifications</span>
                            </Link>
                        </li>
                        <li>
